...
# Adversarial-Conditional VAE
class Audio2ImageACVAE(nn.Module):
    def __init__(self):
        super(Audio2ImageACVAE, self).__init__()
        '''
        input: audio wave
        output:  RGB image / torch.Size([3, 256, 256])
        '''
...
class Image2AudioACVAE(nn.Module):
    def __init__(self):
        super(Image2AudioACVAE, self).__init__()
        '''
        input: audio wave
        output:  RGB image / torch.Size([3, 256, 256])
        '''
